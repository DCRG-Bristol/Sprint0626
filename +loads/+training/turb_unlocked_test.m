...
data = load('GPR_turb_unlocked.mat');
data_2 = load('GPR_WRBM_1.mat');
gprMdl = data.gprMdl_4;
gprMdl_2 = data_2.gprMdl_1;
ranges = data.ranges;
...
for j = 1:50
    ...
    [ypred_2(j), ysd(j), yint(j,:)] = predict(gprMdl_2{j}, testPoint, 'Alpha', 0.05);
end
