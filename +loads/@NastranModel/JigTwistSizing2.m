...
for i = 1:opts.MaxIter+1
    ...
    if i < 3
        ...
        sol.UpdateID(IDs);
        % run NASTRAN
        sol.restart(obj.BinFolder,[DMI_W2GJ],Silent=RunOpts.Silent,NumAttempts=RunOpts.NumAttempts...
            ,TruelySilent=RunOpts.TruelySilent,cmdLineArgs=struct('scr','no','dbs','sol144'));
