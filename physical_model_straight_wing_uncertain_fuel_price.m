function Y = physical_model_straight_wing_uncertain_fuel_price(X, det_P)
%% Title section - Total operating cost (TOC) computations for the straight wing case (uncertain fuel price)
%{
--------------------------------------------------------
Comments:
* The model computes the total operating cost as a function of design variables (i.e., AR and Mach no.) and uncertain variables (i.e., Fuel price, Oil price)
