function Y = physical_model_indep_sweep_and_ar(X)
%% Title section - Block fuel (BF) and Direct operating cost (DOC) computations for the swept wing case
%{
--------------------------------------------------------
Comments:
* The model computes the block fuel, direct operating cost, ... as a function of design variables (i.e., Sweep angle, Mach no., and AR)
