...
%% 21. BayesOpt- Deterministic multi-objective optimisation (minimise fuel cost and TOC) + added fuel and oil price uncertainty
load('bayes_opt_multi_obj_det_opt_for_bf_and_toc.mat')
% remove the runs where BO returns a dominated point (visual inspection)
rowsToRemove = 9;
bf_multi_obj(rowsToRemove) = [];
...
save('bayes_opt_multi_obj_det_opt_for_fuel_cost_and_toc_uncertain_price.mat', 'x_opt_multi_obj', 'predictive_intervals_90')
...
plotIntervals(predictive_intervals_90(:, 1), predictive_intervals_90(:, 2), ...
    ...
    'MarkerSize', 6, ...
    'FontSize', 10);
xlabel('Fuel Cost');  % optional axis label
title('Pareto points: 90% predictive intervals due to fuel price uncertainty');  % optional title
