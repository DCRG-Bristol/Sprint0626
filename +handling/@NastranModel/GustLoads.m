...
%get 1g cruise loads
if Case.Nonlinear
    BinFolder = obj.Sol144nonlin(Case.Mach,Case.Alt,1, BinFolder=obj.BinFolder);      
else
    BinFolder = obj.Sol144(Case.Mach,Case.Alt,1, BinFolder=obj.BinFolder);
end
...
obj.Sol146(Case.Mach,Case.Alt,BinFolder=BinFolder, DispIDs=nan);
