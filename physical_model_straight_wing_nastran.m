function Y = physical_model_straight_wing_nastran(X)
%% Title section - Block fuel (BF) and Direct operating cost (DOC) computations for the straight wing case
%{
--------------------------------------------------------
Comments:
* The model computes the block fuel, direct operating cost, ... as a function of design variables (i.e., AR and Mach no.)
...
load('example_data/UB321_simple_nastran.mat')
...
% collate data
Y = [block_fuel,C_ops,ADP.Span,cd0,cd_cruise,ADP.MTOM];
