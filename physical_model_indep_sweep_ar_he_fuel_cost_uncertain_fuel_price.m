function Y = physical_model_indep_sweep_ar_he_fuel_cost_uncertain_fuel_price(X, det_P)
%% Title section - Fuel cost computations for the swept wing case (uncertain fuel price)
%{
--------------------------------------------------------
Comments:
* The model computes the total operating cost as a function of design variables (i.e., Sweep angle, Mach no.) and uncertain variables (i.e., Fuel price)
